describe('template spec', () => {
  it('passes', () => {
    ...
    cy.wait(5000)
    cy.get('input[type=radio][name=prev_hajj_experience][value="yes"]').click()
    cy.wait(5000)
    cy.get('input[type=text][placeholder=সর্বশেষ ট্রাকিং নম্বর লিখুন]').type('H175DD3B2B')
    cy.wait(5000)
    cy.get('div.bd-card-footer>div>a>button#hajj_experience_no_btn>span').contains('Next').click()
    cy.wait(5000)
